            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto">
                        <p class="pre-wrap lead">Disponemos de las películas más modernas para que nuestros clientes tengan el acceso más rápido y sencillo a ellas.
                        </p>
                    </div>
                    <div class="col-lg-4 mr-auto">
                        <p class="pre-wrap lead">Entra en nuestra cartelera, elige una de nuestras películas y reserva hoy mismo tu entrada en Ucartelera.
                        </p>
                    </div>
                </div>
            </div>
